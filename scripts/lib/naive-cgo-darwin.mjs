...
// The mac frameworks pangea_naive's objects reference, read off the GN targets'
// is_apple/is_mac `frameworks` declarations — the darwin analog of WINDOWS_SYSTEM_LIBS.
...
// System libs beyond the frameworks: net's is_mac block links libresolv, and
// base's Mach port-rendezvous code (audit_token_to_pid) links libbsm.
...
// Darwin counterpart of the Windows resolver in naive-cgo.mjs. Unlike Windows this
// needs no CC wrapper or MSVC env capture — Apple clang is cgo's default CC.
