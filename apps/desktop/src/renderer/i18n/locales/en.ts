...
export const en = {
  ...
  "settings.provisioning.directIp.hint": "Connects by IP, no DNS lookup. The only one that works under lockdown.",
  "settings.provisioning.hubShadowsocks.title": "Shadowsocks",
  "settings.provisioning.hubShadowsocks.hint": "Tunnels account traffic through Shadowsocks, so nobody sees which server you reach. The VPN stays off.",
  "settings.provisioning.hubFronted.title": "Relay",
  "settings.provisioning.hubFronted.hint": "Goes through a relay on a large content network, at an address too widely shared to block cheaply. The relay can't read what it passes on.",
  "settings.provisioning.hubNormal.title": "Normal connection",
  "settings.provisioning.hubNormal.hint": "Plain HTTPS and a normal DNS lookup. Tried last: it's the only one that exposes our domain.",
  ...
  "settings.transport.anytls.desc": "A padded TLS session, smoothing the TLS-in-TLS shape other TLS transports leak.",
