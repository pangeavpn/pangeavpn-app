...
export const en = {
  ...
  "settings.startup.lockdown.hint": "Launches at startup hidden in the tray, reconnects to your last server, and keeps the kill switch on after you disconnect. Nothing but VPN traffic gets out until you turn this off.",
