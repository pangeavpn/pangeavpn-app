...
export const ru = {
  ...
  "settings.startup.lockdown.hint": "Запускается при старте системы скрыто в трее, переподключается к последнему серверу и держит Kill Switch включённым после отключения. Наружу идёт только VPN-трафик, пока вы это не выключите.",
