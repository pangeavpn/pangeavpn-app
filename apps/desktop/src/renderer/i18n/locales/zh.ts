...
export const zh = {
  ...
  "login.error.localStorageFailed": "已登录，但应用无法在这台电脑上保存数据。请检查磁盘是否已满，以及应用是否有权写入其数据文件夹。",
  ...
  "logs.sendDiagnostics": "发送诊断信息",

  "diagnostics.title": "发送诊断信息",
  "diagnostics.body": "这会把应用日志和 VPN 服务日志发给技术支持。账号和密钥会先被移除，你的 IP 地址也一样。",
  "diagnostics.anonymous": "报告是匿名的。我们无法得知是谁发送的，所以你会收到一个短代码，写在邮件里即可。",
  "diagnostics.noteLabel": "备注（可选）",
  "diagnostics.notePlaceholder": "出了什么问题？",
  "diagnostics.send": "发送",
  "diagnostics.cancel": "取消",
  "diagnostics.sending": "正在发送...",
  "diagnostics.sentTitle": "报告已发送",
  "diagnostics.sentBody": "请在给技术支持的邮件中写上这个代码。",
  "diagnostics.copyCode": "复制代码",
  "diagnostics.codeCopied": "已复制",
  "diagnostics.failedTitle": "无法发送",
  "diagnostics.failedBody": "报告没有送达。请点击打开日志文件夹，把日志文件作为附件发送邮件。",
  "diagnostics.rejectedBody": "服务器拒绝了该报告。请点击打开日志文件夹，把日志文件作为附件发送邮件。",
  "diagnostics.done": "关闭",
  ...
  "settings.provisioning.description": "取得 VPN 配置的方式，按列表顺序依次尝试。至少保留一个。",
  "settings.provisioning.directIp.title": "直连 IP",
  "settings.provisioning.directIp.hint": "直接用 IP 连接，不做 DNS 查询。锁定模式下可用。",
  "settings.provisioning.hubReality.title": "REALITY",
  "settings.provisioning.hubReality.hint": "把账户流量送进 REALITY，看起来就像在访问普通网站。无需开启 VPN，锁定模式下也可用。",
  "settings.provisioning.hubShadowsocks.title": "Shadowsocks",
  "settings.provisioning.hubShadowsocks.hint": "把账户流量送进 Shadowsocks，没人看得到您在联系哪台服务器。无需开启 VPN，锁定模式下也可用。",
  "settings.provisioning.hubFronted.title": "中继",
  "settings.provisioning.hubFronted.hint": "经由大型内容网络上的中继，地址与大量网站共用，封锁代价高昂。中继读不了它转发的内容。锁定模式下不可用。",
  "settings.provisioning.hubNormal.title": "常规连接",
  "settings.provisioning.hubNormal.hint": "普通 HTTPS 加普通 DNS 查询。最后才试：只有它会暴露我们的域名。锁定模式下不可用。",
  "settings.provisioning.deadDrop.title": "恢复地址",
  "settings.provisioning.deadDrop.hint": "从公开主机获取带签名的地址列表，在你的设备上验证。最后手段，且不含任何账户信息。",
  "settings.provisioning.deadDrop.description": "若上述方式都没有可用地址，应用可从带签名的公开文件获取替代地址。",
  ...
  "settings.provisioning.result.noRealityCredentials": "尚未保存 REALITY 凭据",
  ...
  "settings.transport.cloak.desc": "指向诱饵站点的 TLS，流量看起来就像一次普通访问。",
  "settings.transport.naive.desc": "真正的 Chromium TLS 和 HTTP/2，指纹与普通浏览器一致。",
  "settings.transport.reality.desc": "借用真实网站的 TLS 握手，探测看到的是一个真站点。最强的伪装。",
  "settings.transport.hysteria2.desc": "用 UDP 和 QUIC 而非 TCP。所有 TCP 连接都断时值得一试。",
  "settings.transport.shadowsocks.desc": "完全不用 TLS，针对 TLS 的封锁碰不到它。",
  "settings.transport.wireguard.desc": "直连服务器，没有任何遮掩。审查者最容易识别并切断。",
  "settings.network.heading": "网络",
  "settings.network.description": "隧道设置，以及针对受限 Wi-Fi 的修复。",
  "settings.network.allowLan.title": "允许 LAN",
  "settings.network.allowLan.hint": "让本地流量（路由器、打印机、强制门户）绕开隧道。若 Wi-Fi 老是掉到\"无网络连接\"，就开启它。下次连接时生效。",
  "settings.network.postQuantum.title": "后量子密钥",
  "settings.network.postQuantum.hint": "为隧道添加抗量子密钥，今天被截获的流量日后也无法解密。下次连接时生效。",
  ...
  "settings.network.mtu.hint": "隧道里的数据包大小。若在其他方面正常的网络上页面卡住，就调低它。默认 1380。下次连接时生效。",
  ...
  "settings.startup.launch.hint": "登录时启动 PangeaVPN。它以隐藏方式打开，用托盘图标进入。",
  "settings.startup.autoConnect.title": "自动连接",
  "settings.startup.autoConnect.hint": "启动时自动连接上次使用的服务器，隧道断开后自动重连。若您自己断开，则暂停，直到您再次连接。",
  "settings.startup.lockdown.title": "锁定模式",
  "settings.startup.lockdown.hint": "断开连接后仍保持断网保护开启。在您关掉它之前，只有 VPN 流量能出去，包括电脑刚开机时。",
  ...
  "settings.appearance.description": "应用中使用的强调色。",
  ...
  "settings.support.heading": "支持",
  "settings.support.description": "将日志发送给支持团队，个人信息会先被移除。你会收到一个代码，在邮件中注明。",
  "settings.support.send": "发送报告",
  "settings.update.heading": "软件更新",
  "settings.update.check": "检查更新",
  "settings.developer.heading": "开发者选项",
  "settings.developer.description": "调试用的诊断项。除非有人要求，否则请保持关闭。",
  "settings.developer.hubInTunnel.title": "让中枢流量走隧道",
  "settings.developer.hubInTunnel.hint": "账户和服务器流量走 VPN，而不是绕过它。可能会拖慢重连和切换服务器。下次连接时生效。",
  ...
  "toggle.postQuantum.on": "已启用后量子密钥。请重新连接以生效。",
  "toggle.postQuantum.off": "已禁用后量子密钥。请重新连接以生效。",
