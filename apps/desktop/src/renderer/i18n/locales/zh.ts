...
export const zh = {
  ...
  "settings.provisioning.directIp.hint": "直接用 IP 连接，不做 DNS 查询。断网保护锁定时唯一可用的方式。",
  "settings.provisioning.hubShadowsocks.title": "Shadowsocks",
  "settings.provisioning.hubShadowsocks.hint": "把账户流量送进 Shadowsocks，没人看得到您在联系哪台服务器。VPN 保持关闭。",
  "settings.provisioning.hubFronted.title": "中继",
  "settings.provisioning.hubFronted.hint": "经由大型内容网络上的中继，地址与大量网站共用，封锁代价高昂。中继读不了它转发的内容。",
  "settings.provisioning.hubNormal.title": "常规连接",
  "settings.provisioning.hubNormal.hint": "普通 HTTPS 加普通 DNS 查询。最后才试：只有它会暴露我们的域名。",
  ...
  "settings.transport.anytls.desc": "带填充的 TLS 会话，抹平其他 TLS 传输暴露的 TLS-in-TLS 特征。",
