...
export const fa = {
  ...
  "settings.provisioning.directIp.hint": "با IP وصل می‌شود، بدون جست‌وجوی DNS. تنها روشی که با قفل محافظ کار می‌کند.",
  "settings.provisioning.hubShadowsocks.title": "Shadowsocks",
  "settings.provisioning.hubShadowsocks.hint": "ترافیک حساب را از Shadowsocks رد می‌کند، پس کسی نمی‌بیند با کدام سرور تماس می‌گیرید. VPN خاموش می‌ماند.",
  "settings.provisioning.hubFronted.title": "بازپخش",
  "settings.provisioning.hubFronted.hint": "از یک بازپخش روی شبکهٔ محتوای بزرگ می‌گذرد، با نشانی‌ای که مسدودکردنش گران تمام می‌شود. بازپخش نمی‌تواند آنچه را رد می‌کند بخواند.",
  "settings.provisioning.hubNormal.title": "اتصال عادی",
  "settings.provisioning.hubNormal.hint": "HTTPS معمولی و جست‌وجوی DNS عادی. آخر از همه امتحان می‌شود: تنها روشی است که دامنه ما را آشکار می‌کند.",
  ...
  "settings.transport.anytls.desc": "یک نشست TLS با لایه‌گذاری که الگوی TLS-در-TLS را که دیگر ترابری‌های TLS نشان می‌دهند، هموار می‌کند.",
