...
export const fa = {
  ...
  "login.error.localStorageFailed": "وارد شدید، اما برنامه نتوانست داده‌ها را روی این رایانه ذخیره کند. بررسی کنید که دیسک پر نباشد و برنامه اجازهٔ نوشتن در پوشهٔ داده‌هایش را داشته باشد.",
  ...
  "logs.clear": "پاک کردن",
  "logs.openFolder": "باز کردن پوشهٔ گزارش‌ها",
  "logs.sendDiagnostics": "ارسال گزارش عیب‌یابی",

  "diagnostics.title": "ارسال گزارش عیب‌یابی",
  "diagnostics.body": "این کار گزارش برنامه و گزارش سرویس VPN را برای پشتیبانی می‌فرستد. شماره حساب و کلیدها پیش از ارسال حذف می‌شوند، نشانی IP شما هم همین‌طور.",
  "diagnostics.anonymous": "گزارش ناشناس است. ما نمی‌توانیم بفهمیم چه کسی آن را فرستاده، پس یک کد کوتاه می‌گیرید تا در ایمیل بنویسید.",
  "diagnostics.noteLabel": "یادداشت (اختیاری)",
  "diagnostics.notePlaceholder": "چه مشکلی پیش آمد؟",
  "diagnostics.send": "ارسال",
  "diagnostics.cancel": "لغو",
  "diagnostics.sending": "در حال ارسال...",
  "diagnostics.sentTitle": "گزارش ارسال شد",
  "diagnostics.sentBody": "این کد را در ایمیل خود به پشتیبانی بنویسید.",
  "diagnostics.copyCode": "کپی کد",
  "diagnostics.codeCopied": "کپی شد",
  "diagnostics.failedTitle": "ارسال نشد",
  "diagnostics.failedBody": "گزارش به ما نرسید. روی باز کردن پوشهٔ گزارش‌ها بزنید و فایل را به ایمیل خود پیوست کنید.",
  "diagnostics.rejectedBody": "سرور گزارش را نپذیرفت. روی باز کردن پوشهٔ گزارش‌ها بزنید و فایل را به ایمیل خود پیوست کنید.",
  "diagnostics.done": "بستن",
  ...
  "settings.account.number": "شماره حساب",
  "settings.account.show": "نمایش",
  "settings.account.hide": "پنهان کردن",
  "settings.account.devices": "دستگاه‌ها",
  "settings.account.signOut": "خروج",
  "settings.summary.off": "خاموش",
  "settings.provisioning.heading": "آماده‌سازی اتصال",
  "settings.provisioning.description": "روش‌های گرفتن پروفایل VPN، به‌ترتیب فهرست امتحان می‌شوند. دست‌کم یکی را روشن نگه دارید.",
  "settings.provisioning.directIp.title": "IP مستقیم",
  "settings.provisioning.directIp.hint": "با IP وصل می‌شود، بدون جست‌وجوی DNS. در حالت قفل کامل هم کار می‌کند.",
  "settings.provisioning.hubReality.title": "REALITY",
  "settings.provisioning.hubReality.hint": "ترافیک حساب را از REALITY رد می‌کند که شبیه بازدید از یک وب‌سایت معمولی است. با VPN خاموش کار می‌کند، حتی در حالت قفل کامل.",
  "settings.provisioning.hubShadowsocks.title": "Shadowsocks",
  "settings.provisioning.hubShadowsocks.hint": "ترافیک حساب را از Shadowsocks رد می‌کند، پس کسی نمی‌بیند با کدام سرور تماس می‌گیرید. با VPN خاموش کار می‌کند، حتی در حالت قفل کامل.",
  "settings.provisioning.hubFronted.title": "بازپخش",
  "settings.provisioning.hubFronted.hint": "از یک بازپخش روی شبکهٔ محتوای بزرگ می‌گذرد، با نشانی‌ای که مسدودکردنش گران تمام می‌شود. بازپخش نمی‌تواند آنچه را رد می‌کند بخواند. در حالت قفل کامل کار نمی‌کند.",
  "settings.provisioning.hubNormal.title": "اتصال عادی",
  "settings.provisioning.hubNormal.hint": "HTTPS معمولی و جست‌وجوی DNS عادی. آخر از همه امتحان می‌شود: تنها روشی است که دامنه ما را آشکار می‌کند. در حالت قفل کامل کار نمی‌کند.",
  "settings.provisioning.deadDrop.title": "بازیابی نشانی‌ها",
  "settings.provisioning.deadDrop.hint": "از یک میزبان عمومی فهرست نشانی امضاشده می‌گیرد که روی دستگاه شما بررسی می‌شود. آخرین راه، و هیچ اطلاعات حسابی ندارد.",
  "settings.provisioning.deadDrop.description": "اگر روش‌های بالا نشانی نداشته باشند، برنامه می‌تواند جایگزین‌ها را از یک فایل عمومی امضاشده بگیرد.",
  "settings.provisioning.lastMethod": "دست‌کم یک روش اتصال باید فعال بماند.",
  "settings.provisioning.test": "آزمایش",
  "settings.provisioning.testing": "در حال آزمایش…",
  "settings.provisioning.inUse": "در حال استفاده",
  "settings.provisioning.active.none": "هنوز هیچ روشی استفاده نمی‌شود",
  "settings.provisioning.active.using": "در حال استفاده: {method}",
  "settings.provisioning.active.detail": "در حال استفاده: {method} — {detail}",
  "settings.provisioning.result.ok": "کار می‌کند ({ms} میلی‌ثانیه)",
  "settings.provisioning.result.okDetail": "از طریق {detail} کار می‌کند ({ms} میلی‌ثانیه)",
  "settings.provisioning.result.fail": "دسترسی به سرورهای ما ممکن نشد",
  "settings.provisioning.result.noAddress": "هنوز نشانی ذخیره نشده و DNS رمزگذاری‌شده خاموش است",
  "settings.provisioning.result.noCredentials": "هنوز اعتبارنامه Shadowsocks ذخیره نشده است",
  "settings.provisioning.result.noRealityCredentials": "هنوز اعتبارنامه REALITY ذخیره نشده است",
  "settings.provisioning.result.noRelay": "هنوز هیچ بازپخشی پیکربندی نشده است",
  "settings.provisioning.result.busy": "آزمایش دیگری هنوز در حال اجراست",
  "settings.transport.heading": "دور زدن سانسور",
  ...
  "settings.transport.wireguard": "WireGuard (بدون استتار)",
  "settings.transport.snowflake": "Snowflake",
  "settings.transport.auto.desc": "هر استتار را به‌ترتیب امتحان می‌کند و به‌یاد می‌سپارد روی این شبکه چه جواب داد.",
  "settings.transport.cloak.desc": "TLS به‌سمت یک سایت طعمه، طوری که ترافیک مثل بازدیدی عادی به‌نظر برسد.",
  "settings.transport.naive.desc": "TLS و HTTP/2 واقعی Chromium، پس اثر انگشت با یک مرورگر معمولی یکی است.",
  "settings.transport.reality.desc": "دست‌دادن TLS یک سایت واقعی را قرض می‌گیرد، پس کاوش‌ها یک سایت اصیل می‌بینند. قوی‌ترین استتار.",
  "settings.transport.hysteria2.desc": "UDP و QUIC به‌جای TCP. وقتی همه اتصال‌های TCP می‌افتند، ارزش امتحان دارد.",
  "settings.transport.shadowsocks.desc": "هیچ TLS ندارد، پس مسدودسازیِ متمرکز بر TLS به آن نمی‌رسد.",
  "settings.transport.wireguard.desc": "مستقیم به سرور وصل می‌شود، بدون هیچ پوششی. آسان‌ترین روش برای اینکه سانسورچی ببیند و قطع کند.",
  "settings.network.heading": "شبکه",
  "settings.network.description": "تنظیمات تونل و رفع مشکل شبکه‌های Wi-Fi محدودکننده.",
  "settings.network.allowLan.title": "اجازه به LAN",
  "settings.network.allowLan.hint": "می‌گذارد ترافیک شبکه محلی (روتر، چاپگرها، درگاه‌های ورود) تونل را دور بزند. اگر Wi-Fi مدام به \"بدون اینترنت\" می‌افتد، روشنش کنید. از اتصال بعدی اعمال می‌شود.",
  "settings.network.postQuantum.title": "کلید پساکوانتومی",
  "settings.network.postQuantum.hint": "کلیدی مقاوم در برابر رایانش کوانتومی به تونل اضافه می‌کند تا ترافیک ضبط‌شده امروز بعداً رمزگشایی نشود. از اتصال بعدی اعمال می‌شود.",
  "settings.network.dns.provider.title": "ارائه‌دهنده DNS",
  "settings.network.dns.provider.hint": "یک سرویس DNS انتخاب کنید یا نشانی خودتان را وارد کنید. فیلترسازی از همان سرویس می‌آید. از اتصال بعدی اعمال می‌شود.",
  ...
  "settings.network.dns.hint": "نشانی‌های IPv4 با ویرگول جدا شده. برای پیش‌فرض VPN خالی بگذارید. از اتصال بعدی اعمال می‌شود.",
  ...
  "settings.network.mtu.hint": "اندازه بسته‌ها در تونل. اگر صفحه‌ها در شبکه‌ای که در بقیه موارد کار می‌کند هنگ می‌کنند، کمش کنید. پیش‌فرض 1380. از اتصال بعدی اعمال می‌شود.",
  ...
  "settings.startup.launch.hint": "PangeaVPN را هنگام ورود اجرا می‌کند. پنهان باز می‌شود، از آیکون سینی استفاده کنید.",
  "settings.startup.autoConnect.title": "اتصال خودکار",
  "settings.startup.autoConnect.hint": "هنگام اجرای PangeaVPN به آخرین سرور وصل می‌شود و اگر تونل قطع شود دوباره وصل می‌شود. اگر خودتان قطع کنید، تا اتصال بعدی قطع می‌ماند.",
  "settings.startup.lockdown.title": "قفل کامل",
  "settings.startup.lockdown.hint": "کلید قطع اضطراری را پس از قطع اتصال روشن نگه می‌دارد. تا وقتی خاموشش نکنید فقط ترافیک VPN بیرون می‌رود، از جمله بلافاصله پس از روشن شدن رایانه.",
  "settings.notifications.heading": "اعلان‌ها",
  "settings.notifications.description": "اعلان‌های سیستم درباره اتصال شما.",
  "settings.notifications.status.title": "هشدارهای اتصال",
  "settings.notifications.status.hint": "هنگام اتصال، افت، بازگشت یا قطع VPN به شما اطلاع می‌دهد.",
  ...
  "settings.appearance.description": "رنگ تأکیدی مورد استفاده در برنامه.",
  ...
  "settings.support.heading": "پشتیبانی",
  "settings.support.description": "گزارش‌های خود را بدون اطلاعات شخصی برای پشتیبانی بفرستید. یک کد می‌گیرید که در ایمیل خود بنویسید.",
  "settings.support.send": "ارسال گزارش",
  ...
  "settings.developer.hubInTunnel.hint": "ترافیک حساب و سرورها را به‌جای دور زدن تونل، از VPN می‌گذراند. ممکن است اتصال دوباره و تعویض سرور را کند کند. در اتصال بعدی اعمال می‌شود.",
  ...
  "update.macBlockedHint": "در شبکه شما مسدود است؟ به جای آن از این استفاده کنید:",
  ...
  "toggle.postQuantum.on": "کلید پساکوانتومی فعال شد. برای اعمال، دوباره متصل شوید.",
  "toggle.postQuantum.off": "کلید پساکوانتومی غیرفعال شد. برای اعمال، دوباره متصل شوید.",
  ...
  "toggle.autoConnect.failed": "به‌روزرسانی اتصال خودکار ناموفق بود.",
  "toggle.autoConnect.on": "اتصال خودکار روشن شد — PangeaVPN هنگام اجرا و پس از قطعی دوباره وصل می‌شود.",
  "toggle.autoConnect.off": "اتصال خودکار خاموش شد.",
  "toggle.notifications.on": "هشدارهای اتصال روشن شد.",
  "toggle.notifications.off": "هشدارهای اتصال خاموش شد.",
  "toggle.notifications.failed": "به‌روزرسانی اعلان‌ها ناموفق بود.",
  "toggle.deadDrop.on": "بازیابی نشانی‌ها روشن است — تنها زمانی استفاده می‌شود که همه روش‌های بالا شکست بخورند.",
  "toggle.deadDrop.off": "بازیابی نشانی‌ها خاموش است.",
  "toggle.lockdown.failed": "به‌روزرسانی قفل کامل ناموفق بود.",
  "toggle.lockdown.on": "قفل کامل روشن شد — کلید قطع اضطراری تا زمانی که آن را خاموش کنید روشن می‌ماند.",
