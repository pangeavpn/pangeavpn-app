...
export const fa = {
  ...
  "settings.provisioning.description": "برنامه چطور پروفایل VPN شما را می‌گیرد. هر روش فعال را به‌ترتیب امتحان می‌کند. دست‌کم یکی را روشن نگه دارید.",
  "settings.provisioning.directIp.title": "IP مستقیم",
  "settings.provisioning.directIp.hint": "با آدرس IP وصل می‌شود، بدون جست‌وجوی DNS. تنها روشی که با قفل محافظ فعال کار می‌کند.",
  "settings.provisioning.hubShadowsocks.title": "Shadowsocks",
  "settings.provisioning.hubShadowsocks.hint": "ترافیک حساب را از تونل Shadowsocks رد می‌کند، پس کسی نمی‌بیند با کدام سرور تماس می‌گیرید. VPN خاموش می‌ماند.",
  "settings.provisioning.hubFronted.title": "بازپخش",
  "settings.provisioning.hubFronted.hint": "از یک بازپخش روی شبکهٔ محتوای بزرگ می‌گذرد، با نشانی‌ای که با بخش زیادی از وب مشترک است و مسدودکردنش گران تمام می‌شود. بازپخش فقط داده‌های مهروموم‌شده‌ای را رد می‌کند که نمی‌تواند بخواند.",
  "settings.provisioning.hubNormal.title": "اتصال عادی",
  "settings.provisioning.hubNormal.hint": "HTTPS معمولی با جست‌وجوی DNS عادی. آخر از همه امتحان می‌شود، چون تنها روشی است که دامنه ما را آشکار می‌کند.",
  "settings.provisioning.deadDrop.title": "بازیابی نشانی‌ها",
  "settings.provisioning.deadDrop.hint": "فهرستی از نشانی‌های جایگزین را که توسط ما امضا شده و روی دستگاه شما بررسی می‌شود، از یک میزبان عمومی می‌گیرد. تنها پس از شکست همه روش‌های دیگر استفاده می‌شود و هیچ اطلاعات حسابی ندارد.",
  "settings.provisioning.deadDrop.description": "اگر همه روش‌های بالا نشانی کارآمدی نداشته باشند، برنامه می‌تواند نشانی‌های جایگزین را از یک فایل عمومی امضاشده بگیرد.",
  ...
  "settings.transport.auto.desc": "هر استتار را به‌ترتیب امتحان می‌کند و به‌یاد می‌سپارد چه چیزی روی این شبکه جواب داد.",
  "settings.transport.cloak.desc": "مبهم‌سازی TLS به‌سمت یک سایت پوششیِ طعمه، طوری که ترافیک مثل یک بازدید عادی به‌نظر برسد.",
  "settings.transport.naive.desc": "TLS و HTTP/2 واقعی Chromium، پس اثر انگشت با یک مرورگر معمولی یکی است.",
  "settings.transport.reality.desc": "دست‌دادن TLS یک سایت واقعی را قرض می‌گیرد، پس کاوش فعال و مسدودسازی SNI یک سایت اصیل می‌بینند. قوی‌ترین استتار.",
  "settings.transport.hysteria2.desc": "UDP و QUIC به‌جای TCP. وقتی مسدودسازی همه اتصال‌های TCP را می‌بندد، ارزش امتحان دارد.",
  "settings.transport.shadowsocks.desc": "روی درگاه خودش هیچ TLS ندارد، پس مسدودسازیِ متمرکز بر TLS به آن نمی‌رسد.",
  ...
  "settings.network.allowLan.hint": "می‌گذارد ترافیک شبکه محلی (روتر، چاپگرها، درگاه‌های ورود) تونل را دور بزند. اگر Wi-Fi هنگام اتصال مدام به \"بدون اینترنت\" می‌افتد، روشنش کنید. از اتصال بعدی اعمال می‌شود.",
  ...
  "settings.network.mtu.hint": "اندازه بسته‌ها در تونل. اگر صفحه‌ها هنگ می‌کنند یا دانلودها در شبکه‌ای که در بقیه موارد کار می‌کند متوقف می‌شوند، کمش کنید. پیش‌فرض 1380. از اتصال بعدی اعمال می‌شود.",
  ...
  "settings.startup.launch.hint": "PangeaVPN را هنگام ورود به رایانه اجرا می‌کند. پنهان باز می‌شود، برای دسترسی از آیکون سینی استفاده کنید.",
  ...
  "settings.startup.lockdown.hint": "کلید قطع اضطراری را حتی پس از قطع اتصال روشن نگه می‌دارد. تا وقتی خاموشش نکنید فقط ترافیک VPN بیرون می‌رود — از جمله بلافاصله پس از روشن شدن رایانه.",
  ...
  "settings.notifications.status.hint": "هنگام اتصال VPN، قطع ارتباط، بازگشت به اینترنت یا قطع اتصال به شما اطلاع می‌دهد.",
