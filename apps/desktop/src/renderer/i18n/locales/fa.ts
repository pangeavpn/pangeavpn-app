...
export const fa = {
  ...
  "settings.startup.lockdown.hint": "هنگام راه‌اندازی سیستم پنهان در سینی اجرا می‌شود، به آخرین سرور وصل می‌شود و پس از قطع اتصال کلید قطع اضطراری را روشن نگه می‌دارد. تا وقتی خاموشش نکنید فقط ترافیک VPN بیرون می‌رود.",
