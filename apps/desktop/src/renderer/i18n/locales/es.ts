...
export const es = {
  ...
  "settings.startup.lockdown.hint": "Se inicia con el sistema, oculto en la bandeja, se reconecta al último servidor y mantiene el Kill Switch activo tras desconectarte. Solo sale tráfico de la VPN hasta que lo desactives.",
