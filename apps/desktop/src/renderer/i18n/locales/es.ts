...
export const es = {
  ...
  "settings.censorship.description": "Cómo llega la aplicación a los servidores de tu cuenta. Cada método activado se prueba por turno; al menos uno debe seguir activo.",
  ...
  "settings.transport.heading": "Método de conexión",
  "settings.transport.description": "Cómo PangeaVPN camufla tu tráfico.",
  "settings.transport.auto": "Automático (recomendado)",
  "settings.transport.cloak": "Solo Cloak",
  "settings.transport.naive": "Solo NaiveProxy",
  "settings.transport.reality": "Solo VLESS+REALITY",
  "settings.transport.hysteria2": "Solo Hysteria2",
  "settings.transport.shadowsocks": "Solo Shadowsocks",
  "settings.transport.wireguard": "Solo WireGuard (sin camuflaje)",
  "settings.transport.snowflake": "Solo Snowflake",
  ...
  "settings.network.dns.provider.hint": "Elige un servicio DNS o introduce el tuyo. El filtrado depende del servicio seleccionado. Se aplica en la próxima conexión.",
  ...
  "settings.network.dns.hint": "Servidores DNS IPv4 separados por comas, por ejemplo 1.1.1.1, 1.0.0.1. Déjalo vacío para usar el valor predeterminado de la VPN. Se aplica en la próxima conexión.",
  ...
  "settings.network.mtu.hint": "Tamaño de los paquetes enviados por el túnel. Redúcelo si las páginas se quedan colgadas o las descargas grandes se detienen en una red que por lo demás conecta bien. Valor predeterminado: 1380. Se aplica en la próxima conexión.",
