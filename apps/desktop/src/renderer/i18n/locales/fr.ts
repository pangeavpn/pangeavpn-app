...
export const fr = {
  ...
  "settings.censorship.description": "Comment l'application joint les serveurs de votre compte. Chaque méthode activée est essayée à son tour ; au moins une doit rester active.",
  ...
  "settings.network.dns.provider.hint": "Choisissez un service DNS ou saisissez le vôtre. Le filtrage dépend du service sélectionné. Prend effet à la prochaine connexion.",
  ...
  "settings.network.dns.hint": "Serveurs DNS IPv4 séparés par des virgules, par exemple 1.1.1.1, 1.0.0.1. Laissez vide pour utiliser la valeur VPN par défaut. Prend effet à la prochaine connexion.",
  ...
  "settings.network.mtu.hint": "Taille des paquets envoyés dans le tunnel. Réduisez-la si les pages se figent ou si les gros téléchargements s'interrompent sur un réseau qui se connecte normalement. Valeur par défaut : 1380. Prend effet à la prochaine connexion.",
