...
export const fr = {
  ...
  "settings.startup.lockdown.hint": "Se lance au démarrage, masqué dans la barre d'état, se reconnecte au dernier serveur et garde le kill switch actif après déconnexion. Seul le trafic VPN passe tant que vous ne le désactivez pas.",
