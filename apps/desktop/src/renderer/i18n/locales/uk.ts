...
export const uk = {
  ...
  "settings.provisioning.deadDrop.hint": "Завантажує список запасних адрес, підписаний нами та перевірений на вашому пристрої, із загальнодоступного хосту. Використовується лише після того, як усе інше не спрацювало. Дані облікового запису не передаються.",
  "settings.provisioning.deadDrop.description": "Якщо в усіх наведених вище методів не лишилося робочих адрес, застосунок може отримати нові з підписаного загальнодоступного файлу.",
  ...
  "settings.notifications.status.hint": "Повідомляє, коли VPN підключається, втрачає зв'язок, знову виходить у мережу або відключається.",
