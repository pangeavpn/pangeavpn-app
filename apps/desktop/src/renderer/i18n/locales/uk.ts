...
export const uk = {
  ...
  "settings.startup.lockdown.hint": "Запускається зі стартом системи, прихованим у треї, перепідключається до останнього сервера й тримає аварійне вимкнення увімкненим після відключення. Назовні йде лише трафік VPN, доки ви це не вимкнете.",
