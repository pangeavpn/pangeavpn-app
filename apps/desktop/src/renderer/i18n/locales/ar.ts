...
export const ar = {
  ...
  "settings.provisioning.directIp.hint": "يتصل عبر IP، دون بحث DNS. الوحيدة التي تعمل عند تفعيل قفل الحماية.",
  "settings.provisioning.hubShadowsocks.title": "Shadowsocks",
  "settings.provisioning.hubShadowsocks.hint": "يمرّر حركة الحساب عبر Shadowsocks، فلا يرى أحد الخادم الذي تتصل به. يبقى VPN متوقفًا.",
  "settings.provisioning.hubFronted.title": "مُرحِّل",
  "settings.provisioning.hubFronted.hint": "يمرّ عبر مُرحِّل على شبكة محتوى كبيرة، بعنوان مشترك مع جزء كبير من الويب وحجبه مكلف. لا يستطيع المُرحِّل قراءة ما ينقله.",
  ...
  "settings.transport.anytls.desc": "جلسة TLS مبطَّنة، تخفّف بصمة TLS داخل TLS التي تظهرها وسائط TLS الأخرى.",
