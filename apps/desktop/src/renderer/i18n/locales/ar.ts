...
export const ar = {
  ...
  "login.error.localStorageFailed": "تم تسجيل الدخول، لكن تعذّر على التطبيق الحفظ على هذا الكمبيوتر. تحقّق من أن القرص غير ممتلئ وأن التطبيق يستطيع الكتابة في مجلد بياناته.",
  ...
  "logs.clear": "مسح",
  "logs.openFolder": "فتح مجلد السجلات",
  "logs.sendDiagnostics": "إرسال التشخيص",

  "diagnostics.title": "إرسال التشخيص",
  "diagnostics.body": "يرسل هذا سجل التطبيق وسجل خدمة VPN إلى الدعم. تُزال أرقام الحسابات والمفاتيح أولاً، وكذلك عنوان IP الخاص بك.",
  "diagnostics.anonymous": "التقرير مجهول المصدر. لا يمكننا معرفة من أرسله، لذلك ستحصل على رمز قصير تذكره في رسالتك.",
  "diagnostics.noteLabel": "ملاحظة (اختياري)",
  "diagnostics.notePlaceholder": "ما الذي حدث؟",
  "diagnostics.send": "إرسال",
  "diagnostics.cancel": "إلغاء",
  "diagnostics.sending": "جارٍ الإرسال...",
  "diagnostics.sentTitle": "تم إرسال التقرير",
  "diagnostics.sentBody": "اذكر هذا الرمز في رسالتك إلى الدعم.",
  "diagnostics.copyCode": "نسخ الرمز",
  "diagnostics.codeCopied": "تم النسخ",
  "diagnostics.failedTitle": "تعذر الإرسال",
  "diagnostics.failedBody": "لم يصل التقرير. اضغط على فتح مجلد السجلات وأرفق ملف السجل برسالتك.",
  "diagnostics.rejectedBody": "رفض الخادم التقرير. اضغط على فتح مجلد السجلات وأرفق ملف السجل برسالتك.",
  "diagnostics.done": "إغلاق",
  ...
  "settings.account.number": "رقم الحساب",
  ...
  "settings.provisioning.description": "طرق جلب ملف VPN، تُجرَّب بترتيب القائمة. أبقِ واحدة على الأقل.",
  "settings.provisioning.directIp.title": "IP مباشر",
  "settings.provisioning.directIp.hint": "يتصل عبر IP، دون بحث DNS. يعمل في وضع الإغلاق التام.",
  "settings.provisioning.hubReality.title": "REALITY",
  "settings.provisioning.hubReality.hint": "يمرّر حركة الحساب عبر REALITY، فتبدو كزيارة لموقع ويب عادي. يعمل وVPN متوقف، حتى في وضع الإغلاق التام.",
  "settings.provisioning.hubShadowsocks.title": "Shadowsocks",
  "settings.provisioning.hubShadowsocks.hint": "يمرّر حركة الحساب عبر Shadowsocks، فلا يرى أحد الخادم الذي تتصل به. يعمل وVPN متوقف، حتى في وضع الإغلاق التام.",
  "settings.provisioning.hubFronted.title": "مُرحِّل",
  "settings.provisioning.hubFronted.hint": "يمرّ عبر مُرحِّل على شبكة محتوى كبيرة، بعنوان مشترك مع جزء كبير من الويب وحجبه مكلف. لا يستطيع المُرحِّل قراءة ما ينقله. لا يعمل في وضع الإغلاق التام.",
  "settings.provisioning.hubNormal.title": "اتصال عادي",
  "settings.provisioning.hubNormal.hint": "HTTPS عادي مع بحث DNS عادي. يُجرَّب أخيرًا لأنه وحده يكشف نطاقنا. لا يعمل في وضع الإغلاق التام.",
  "settings.provisioning.deadDrop.title": "استعادة العناوين",
  "settings.provisioning.deadDrop.hint": "يجلب من مضيف عام قائمة عناوين موقَّعة، يتم التحقق منها على جهازك. ملاذ أخير، ولا تتضمن أي بيانات حساب.",
  "settings.provisioning.deadDrop.description": "إذا نفدت عناوين الطرق أعلاه، يمكن للتطبيق جلب بدائل من ملف عام موقَّع.",
  ...
  "settings.provisioning.result.noRealityCredentials": "لا توجد بيانات اعتماد REALITY محفوظة بعد",
  ...
  "settings.transport.cloak.desc": "TLS موجَّه إلى موقع خادع، فتبدو الحركة كزيارة عادية له.",
  "settings.transport.naive.desc": "TLS وHTTP/2 حقيقيان من Chromium، فتطابق البصمة متصفحًا عاديًا.",
  "settings.transport.reality.desc": "يستعير مصافحة TLS من موقع حقيقي، فيرى الفحص موقعًا أصيلًا. أقوى تمويه.",
  "settings.transport.hysteria2.desc": "UDP وQUIC بدل TCP. يستحق التجربة عندما تنقطع كل اتصالات TCP.",
  "settings.transport.shadowsocks.desc": "لا TLS إطلاقًا، فلا يطاله حجب موجَّه إلى TLS.",
  "settings.transport.wireguard.desc": "يتصل بالخادم مباشرة دون أي تمويه. الأسهل على الرقيب أن يكتشفه ويقطعه.",
  "settings.network.heading": "الشبكة",
  "settings.network.description": "إعدادات النفق وإصلاحات لشبكات Wi-Fi المقيّدة.",
  "settings.network.allowLan.title": "السماح بشبكة LAN",
  "settings.network.allowLan.hint": "يدع حركة الشبكة المحلية (الراوتر، الطابعات، البوابات المقيّدة) تتجاوز النفق. فعّله إذا ظلت Wi-Fi تسقط إلى \"لا يوجد إنترنت\". يسري عند الاتصال التالي.",
  "settings.network.postQuantum.title": "مفتاح ما بعد الكم",
  "settings.network.postQuantum.hint": "يضيف إلى النفق مفتاحًا مقاومًا للحوسبة الكمية، فلا يمكن فك تشفير الحركة الملتقطة اليوم لاحقًا. يسري عند الاتصال التالي.",
  ...
  "settings.network.mtu.hint": "حجم الحزم داخل النفق. قلّله إذا تجمّدت الصفحات على شبكة تعمل بخلاف ذلك. الافتراضي 1380. يسري عند الاتصال التالي.",
  ...
  "settings.startup.launch.hint": "يشغّل PangeaVPN عند تسجيل دخولك. يفتح مخفيًا، استخدم أيقونة شريط النظام.",
  "settings.startup.autoConnect.title": "الاتصال التلقائي",
  "settings.startup.autoConnect.hint": "يتصل بآخر خادم استخدمته عند بدء التشغيل، ويعيد الاتصال إذا انقطع النفق. وإذا قطعت الاتصال بنفسك يتوقف حتى تتصل مرة أخرى.",
  "settings.startup.lockdown.title": "الإغلاق التام",
  "settings.startup.lockdown.hint": "يبقي مفتاح الإيقاف مفعّلًا بعد قطع الاتصال. لا يخرج سوى حركة VPN حتى توقفه، بما في ذلك بعد تشغيل الجهاز مباشرة.",
  ...
  "settings.notifications.status.hint": "ينبهك عند اتصال VPN أو انقطاعه أو عودته.",
  ...
  "settings.appearance.description": "لون التمييز المستخدم في التطبيق.",
  ...
  "settings.support.heading": "الدعم",
  "settings.support.description": "أرسل سجلاتك إلى الدعم بعد إزالة البيانات الشخصية. ستحصل على رمز تذكره في رسالتك.",
  "settings.support.send": "إرسال تقرير",
  ...
  "settings.developer.hubInTunnel.hint": "يمرّر حركة الحساب والخوادم عبر VPN بدل الالتفاف حولها. قد يبطئ إعادة الاتصال وتبديل الخوادم. يسري عند الاتصال التالي.",
  ...
  "toggle.postQuantum.on": "تم تفعيل مفتاح ما بعد الكم. أعد الاتصال ليسري المفعول.",
  "toggle.postQuantum.off": "تم تعطيل مفتاح ما بعد الكم. أعد الاتصال ليسري المفعول.",
